...
public class VigenereView extends JFrame {
    ...
    public JTextField keyLengthField1;
    ...
    public VigenereView() {
        ...
        c.gridy++;
        JPanel keyLengthPanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
        keyLengthPanel.add(new JLabel("Độ dài key:"));
        keyLengthField1 = new JTextField(5);
        keyLengthPanel.add(keyLengthField1);
        mainPanel.add(keyLengthPanel, c);
