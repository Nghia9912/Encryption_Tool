...
public class HillController {
    private HillModel model;
    private HillView view;

    public HillController(HillModel model, HillView view) {
        this.model = model;
        this.view = view;
        initController();
    }
    ...
    private void initController() {
        view.encryptBtn1.addActionListener(e -> {
            ...
            String result = model.encrypt(text, key);
            view.resultArea1.setText(result);
        });

        view.decryptBtn1.addActionListener(e -> {
            String text = view.textArea1.getText();
            String key = view.keyField1.getText();
            String result = model.decrypt(text, key);
            view.resultArea1.setText(result);
        });
        ...
        view.copyAndSaveBtn1.addActionListener(e -> {
            ...
            fc.setSelectedFile(new File("HillKey.txt"));
